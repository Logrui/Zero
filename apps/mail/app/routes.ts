...
export default [
  ...
  layout('(routes)/layout.tsx', [
    ...
    route('/calendar/events', '(routes)/calendar/events/page.tsx'),
    route('/developer', '(routes)/developer/page.tsx'),
    route('/tasks', '(routes)/tasks/page.tsx'),
    route('/workspaces', '(routes)/workspaces/page.tsx'),
    route('/scheduling', '(routes)/scheduling/page.tsx'),
    route('/workflows', '(routes)/workflows/page.tsx'),
    route('/agents', '(routes)/agents/page.tsx'),
    route('/organizations', '(routes)/organizations/page.tsx'),
    route('/people', '(routes)/people/page.tsx'),
